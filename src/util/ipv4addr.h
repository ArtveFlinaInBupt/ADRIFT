...
/// @example ipv4_addr_to_octet(0x01020304, 0) == 0x01
/// @example ipv4_addr_to_octet(0x01020304, 3) == 0x04
static inline u8 ipv4_addr_to_octet(Ipv4Addr addr, u8 octet) {
  return (addr >> ((3 - octet) << 3)) & 0xff;
}
...
/// @example ipv4_addr_to_str(0x01020304, str) == "1.2.3.4"
